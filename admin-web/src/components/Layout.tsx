...
export const NAV_ITEMS: readonly NavItem[] = [
  ...
  { to: '/register', label: 'Register', module: 'ADM-4', built: false },
  { to: '/requirements', label: 'Requirements', module: 'ADM-6', built: false },
  { to: '/exceptions', label: 'Exceptions', module: 'ADM-7', built: false },
